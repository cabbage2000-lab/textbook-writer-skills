...
- [skills/textbook/references/handoff-contract.md](../../skills/textbook/references/handoff-contract.md) 是全项目唯一权威定义,覆盖五块:阶段间交接契约、教材项目落盘布局、`.progress.json` 状态机与重入规则、进度打印与 gate 停点格式、上下文隔离原则;
